...
public class PerspectiveView extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    public AnimationCallback animatorCallback;
    ...
    public void setAnimationCallback(AnimationCallback animatorListener) {
        this.animatorCallback = animatorListener;
    }
    ...
    public void setTextures(boolean isReverse, Bitmap coverTexture, Bitmap contentTexture, float left, float right, float top, float bottom) {
        ...
        animator.addListener(new AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (animatorCallback != null) {
                    animatorCallback.onAnimationEnd();
                }
            }
